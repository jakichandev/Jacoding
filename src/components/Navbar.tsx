...
const Navbar = ({ navState = "sm" }: NavbarProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center w-full justify-between py-4" role="banner">
        ...
        <div role="button" className="relative">
          ...
          <img
            src={expand}
            alt={navActualState === "sm" ? "Apri menu di navigazione" : "Chiudi menu di navigazione"}
        ...
        >
          {routes.map((route, index) => (
            <li 
              ...
              style={{
                animationDelay: navActualState === "lg" ? `${index * 80}ms` : "0ms"
              }}
            >
          ...
          <li 
            ...
            style={{
              animationDelay: navActualState === "lg" ? `${routes.length * 80}ms` : "0ms"
            }}
          >
            <Link 
