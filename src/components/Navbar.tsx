...
const Navbar = ({ navState = "sm" }) => {
  ...
  return (
    <nav
      ...
      className={`fixed z-50 rounded-lg border-1 px-2 border-opacity ml-sections-mobile md:ml-sections mt-6 overflow-hidden flex flex-col items-center animate-navbar transition-all duration-500 overflow-y-auto cursor-pointer ${
